module 0x46566b4a16a1261ab400ab5b9067de84ba152b5eb4016b217187f2a2ca980c5a::i64 {
    ...
    public fun compare(p0: &I64, p1: &I64): u8 {
        let _v0;
        if (eq(p0, p1)) _v0 = 0u8 else {
            let _v1;
            if (lt(p0, p1)) _v1 = 1u8 else _v1 = 2u8;
            _v0 = _v1
        };
        _v0
    }
    ...
    public fun gt(p0: &I64, p1: &I64): bool {
        ...
        if (_v1) _v0 = false else {
            let _v2;
            let _v3;
            if (!*&p0.is_negative) _v3 = *&p1.is_negative else _v3 = false;
            if (_v3) _v2 = true else {
                let _v4;
                let _v5;
                if (*&p0.is_negative) _v5 = *&p1.is_negative else _v5 = false;
                if (_v5) {
                    let _v6 = *&p0.value;
                    let _v7 = *&p1.value;
                    _v4 = _v6 < _v7
