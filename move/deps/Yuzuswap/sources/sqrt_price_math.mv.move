module 0x46566b4a16a1261ab400ab5b9067de84ba152b5eb4016b217187f2a2ca980c5a::sqrt_price_math {
    use 0x1::error;
    ...
    use 0x46566b4a16a1261ab400ab5b9067de84ba152b5eb4016b217187f2a2ca980c5a::unsafe_math;
    public fun get_amount_0_delta(p0: u128, p1: u128, p2: u128, p3: bool): u64 {
        ...
        if (_v6 < 95780971304118053647396689196894323976171195136475135u256) {
            ...
            if (p3) _v7 = math::div_rounding_up_u256(math::div_rounding_up_u256(_v8, _v3), _v2) else _v7 = _v8 / _v3 / _v2;
            let _v9 = _v7;
            ...
            if (_v17 <= _v18) _v0 = _v17 as u64 else abort 5
        };
        _v0
    }
    ...
    fun get_next_sqrt_price_from_amount_0_rounding_up(p0: u128, p1: u128, p2: u64, p3: bool): u128 {
        let _v0;
        let _v1;
        let _v2;
        'l2: loop {
                ...
                'l0: loop {
                    ...
                    loop {
                        if (!(p2 == 0)) {
                            ...
                            _v1 = p2 as u256;
                            if (p3) {
                                if (!((p1 as u256) * _v2 < 95780971304118053647396689196894323976171195136475135u256)) break 'l0;
                                let _v5 = _v1 * _v2;
                                _v4 = _v0 + _v5;
                                if (!(_v4 >= _v0)) break 'l0;
                                break
                            };
                            if ((p1 as u256) * _v2 < 95780971304118053647396689196894323976171195136475135u256) {
                                _v3 = _v1 * _v2;
                                if (_v0 > _v3) break 'l1;
                                abort 4
                            };
    ...
    fun get_next_sqrt_price_from_amount_1_rounding_down(p0: u128, p1: u128, p2: u64, p3: bool): u128 {
        let _v0;
        if (p3) {
    ...
    public fun get_next_sqrt_price_from_input(p0: u128, p1: u128, p2: u64, p3: bool): u128 {
        ...
        assert!(p0 > 0u128, 1);
        assert!(p1 > 0u128, 3);
        if (p3) _v0 = get_next_sqrt_price_from_amount_0_rounding_up(p0, p1, p2, true) else _v0 = get_next_sqrt_price_from_amount_1_rounding_down(p0, p1, p2, true);
        _v0
    }
    public fun get_next_sqrt_price_from_output(p0: u128, p1: u128, p2: u64, p3: bool): u128 {
        ...
        assert!(p0 > 0u128, 1);
        assert!(p1 > 0u128, 3);
        if (p3) _v0 = get_next_sqrt_price_from_amount_1_rounding_down(p0, p1, p2, false) else _v0 = get_next_sqrt_price_from_amount_0_rounding_up(p0, p1, p2, false);
        _v0
    }
}
