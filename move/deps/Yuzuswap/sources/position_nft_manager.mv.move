module yuzuswap::position_nft_manager {
    use 0x1::account;
    ...
    public fun burn(
        p0: &signer, p1: object::Object<liquidity_pool::LiquidityPool>, p2: u64
    ): vector<fungible_asset::FungibleAsset> acquires PositionToken, ResourceSignerCap {
        ...
        let _v10 = &_v9;
        let (_v11, _v12, _v13, _v14, _v15) =
            liquidity_pool::get_position_info(get_nft_manager_acc_addr(), p1, p2);
        ...
        let PositionToken { pool: _v25, position_id: _v26, burn_ref: _v27 } =
            move_from<PositionToken>(_v6);
        token::burn(_v27);
        _v16
    }
    ...
    public fun collect_fee(
        p0: &signer,
        p1: object::Object<liquidity_pool::LiquidityPool>,
        p2: u64,
        p3: u64,
        p4: u64
    ): (fungible_asset::FungibleAsset, fungible_asset::FungibleAsset) acquires ResourceSignerCap {
        let _v0 = object::object_address<liquidity_pool::LiquidityPool>(&p1);
        let _v1 = &_v0;
        let _v2 = get_collection_name(p1);
        let _v3 = &_v2;
        let _v4 = string_utils::to_string<u64>(&p2);
        let _v5 = &_v4;
        let _v6 = object::address_to_object<token::Token>(
            token::create_token_address(_v1, _v3, _v5)
        );
    ...
    public fun collect_reward(
        ...
        p3: u64,
        p4: u64
    ): fungible_asset::FungibleAsset acquires ResourceSignerCap {
        let _v0 = object::object_address<liquidity_pool::LiquidityPool>(&p1);
        let _v1 = &_v0;
        let _v2 = get_collection_name(p1);
        let _v3 = &_v2;
    ...
    friend fun create_collection(
        p0: object::Object<liquidity_pool::LiquidityPool>, p1: string::String
    ): string::String {
        ...
        let _v3 =
            string::utf8(
                vector[
                    89u8, 117u8, 122u8, 117u8, 115u8, 119u8, 97u8, 112u8, 32u8, 108u8, 105u8, 113u8,
                    117u8, 105u8, 100u8, 105u8, 116u8, 121u8, 32u8, 112u8, 111u8, 115u8, 105u8,
                    116u8, 105u8, 111u8, 110u8, 32u8, 99u8, 111u8, 108u8, 108u8, 101u8, 99u8, 116u8,
                    105u8, 111u8, 110u8
                ]
            );
    ...
    fun get_collection_name(p0: object::Object<liquidity_pool::LiquidityPool>): string::String {
        ...
        let _v9 =
            string::utf8(
                vector[
                    89u8, 117u8, 122u8, 117u8, 115u8, 119u8, 97u8, 112u8, 32u8, 108u8, 105u8, 113u8,
                    117u8, 105u8, 100u8, 105u8, 116u8, 121u8, 32u8, 112u8, 111u8, 115u8, 105u8,
                    116u8, 105u8, 111u8, 110u8, 32u8, 124u8, 32u8
                ]
            );
        let _v10 = &mut _v9;
        ...
        string::append_utf8(
            &mut _v9,
            vector[32u8, 124u8, 32u8, 102u8, 101u8, 101u8, 58u8, 32u8]
        );
        let _v14 = &mut _v9;
        ...
        string::append_utf8(
            &mut _v9,
            vector[
                32u8, 124u8, 32u8, 116u8, 105u8, 99u8, 107u8, 32u8, 115u8, 112u8, 97u8, 99u8, 105u8,
                110u8, 103u8, 58u8, 32u8
            ]
        );
        let _v16 = &mut _v9;
    ...
    public fun get_nft_manager_acc_addr(): address acquires ResourceSignerCap {
        account::get_signer_capability_address(
            &borrow_global<ResourceSignerCap>(@yuzuswap).signer_cap
        )
    }

    fun get_nft_manager_acc_signer(): signer acquires ResourceSignerCap {
    ...
    public fun get_position(
        p0: object::Object<liquidity_pool::LiquidityPool>, p1: u64
    ): liquidity_pool::Position acquires ResourceSignerCap {
    ...
    public fun get_positions(
        p0: vector<address>, p1: vector<u64>
    ): vector<option::Option<liquidity_pool::Position>> acquires ResourceSignerCap {
        ...
        loop {
            ...
            let _v12 = &mut _v3;
            let _v13 =
                option::some<liquidity_pool::Position>(
                    liquidity_pool::get_position_with_pending_fees_and_rewards(_v2, _v10, _v11)
                );
    ...
    public fun increase_liquidity(
        ...
        p1: object::Object<liquidity_pool::LiquidityPool>,
        p2: u64,
        p3: &mut fungible_asset::FungibleAsset,
        p4: &mut fungible_asset::FungibleAsset,
        p5: u64,
        p6: u64
        ...
        let (_v17, _v18, _v19, _v20, _v21) =
            liquidity_pool::get_position_info(signer::address_of(_v9), p1, p2);
    ...
    fun init_module(p0: &signer) {
        let (_v0, _v1) =
            account::create_resource_account(
                p0,
                vector[
                    112u8, 111u8, 115u8, 105u8, 116u8, 105u8, 111u8, 110u8, 95u8, 110u8, 102u8,
                    116u8, 95u8, 109u8, 97u8, 110u8, 97u8, 103u8, 101u8, 114u8
                ]
            );
    ...
    public fun is_owner(
        p0: object::Object<liquidity_pool::LiquidityPool>, p1: address, p2: u64
    ): bool {
        ...
        let _v4 = string_utils::to_string<u64>(&p2);
        let _v5 = &_v4;
        object::is_owner<token::Token>(
            object::address_to_object<token::Token>(token::create_token_address(_v1, _v3, _v5)),
            p1
        )
    }
    ...
    public fun mint(
        ...
        p3: u32,
        p4: &mut fungible_asset::FungibleAsset,
        p5: &mut fungible_asset::FungibleAsset,
        p6: u64,
        p7: u64
    ): u64 acquires ResourceSignerCap {
    ...
    public fun quote_remove_liquidity(
        p0: object::Object<liquidity_pool::LiquidityPool>,
        p1: vector<u64>,
        p2: vector<u128>,
        p3: bool,
        p4: bool
