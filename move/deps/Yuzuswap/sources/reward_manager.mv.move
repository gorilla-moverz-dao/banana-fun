module yuzuswap::reward_manager {
    ...
    fun assert_whitelisted_reward_token(p0: object::Object<fungible_asset::Metadata>)
        acquires Config
    {
        assert!(smart_table::contains<object::Object<fungible_asset::Metadata>,bool>(&borrow_global<Config>(@yuzuswap).whitelisted_reward_tokens, p0), 501);
    }
    public fun get_whitelisted_reward_tokens(): vector<object::Object<fungible_asset::Metadata>>
        acquires Config
    {
        smart_table::keys<object::Object<fungible_asset::Metadata>,bool>(&borrow_global<Config>(@yuzuswap).whitelisted_reward_tokens)
    }
        ...
        acquires Config
    {
        ...
        let _v0 = smart_table::remove<object::Object<fungible_asset::Metadata>,bool>(&mut borrow_global_mut<Config>(@yuzuswap).whitelisted_reward_tokens, p1);
    }
    ...
    {
        config::assert_reward_admin(p0);
        smart_table::upsert<object::Object<fungible_asset::Metadata>,bool>(&mut borrow_global_mut<Config>(@yuzuswap).whitelisted_reward_tokens, p1, true);
    }
