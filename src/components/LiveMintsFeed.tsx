...
/**
 * Live mints feed showing recent mints across all collections
 */
export function LiveMintsFeed() {
	const recentMints = useQuery(api.reveal.getAllRecentMints);
	...
	return (
		<GlassCard className="gap-1">
			...
			<CardContent>
				<div className="max-h-[250px] overflow-y-auto rounded-lg bg-black/20">
					{/* Header */}
								...
								<div className="flex items-center gap-3 min-w-0">
									...
									<div className="min-w-0">
										...
										<div className="text-xs text-muted-foreground truncate">
											{mint.name}
											<span className="text-primary/70 ml-1">in {mint.collectionName}</span>
										</div>
									</div>
								</div>
